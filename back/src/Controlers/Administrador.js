...
async function inserirAdm_gerente(Admin) {
  ...
  try {
    ...
    const query = {
      sql: 'INSERT INTO administrador SET nomeAD = ?, email = ?, telefone = ?, idUsuario = ?, idGestor = ?',
      values: [Admin.nomeAdm, Admin.emailAdm, Admin.telefone, Admin.idUsuario, Admin.idGestor]
    };
